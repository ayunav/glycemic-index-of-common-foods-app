...
//Set up the selection interaction in the second UITableViewController. You'll need to implement one of the UITableViewDelegate methods. The checkmark is cell.accessoryType, so it's built in.
